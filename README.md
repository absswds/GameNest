...
LAN Board Games is a self-hosted tabletop game room for family, friends, classrooms, and small gatherings. Start one Node.js server, open the lobby in a browser, and let other phones or laptops join from the same WiFi through a QR code or the host IP.
