(function() {
  const catalog = {
    ...
    monopoly: {
      ...
      icon: 'M',
      subtitle: '买地建房，越滚越大',
      description: '更有戏剧性的多人桌游，最适合做首页主推。',
      players: '2-6人',
      duration: '约20分钟',
      category: '桌面策略',
      tags: ['经营', '事件卡'],
    ...
    suikabattle: {
      ...
      icon: '◔',
      subtitle: '物理掉落，越合越大',
      description: '观感最好的一批玩法之一，值得用更强封面承接。',
      players: '2-4人',
      duration: '约10分钟',
      category: '实时对战',
      tags: ['物理', '爽感'],
    ...
    sheeptile: {
      ...
      icon: 'Y',
      subtitle: '三消堆叠，清盘才赢',
      description: '层叠视效很强，适合做成更精致的精品小局。',
      players: '2-6人',
      duration: '约10分钟',
      category: '脑力竞速',
      tags: ['消除', '堆叠'],
    ...
    drawguess: {
      ...
      icon: '✎',
      subtitle: '传话接龙，越歪越好笑',
      description: '最适合拉人进房的社交玩法，首页曝光应该更强。',
      players: '2-8人',
      duration: '约15分钟',
      category: '派对卡牌',
      tags: ['社交', '欢乐'],
  ...
  window.gameCatalog = {
    ...
    categories: function() {
      ...
      order.forEach(function(id) {
        ...
        if (!item || seen[item.category]) return;
