  ...
  var TUTORIALS = {
    ...
    drawguess: {
      ...
      sections: [
        ...
        { h: '两种玩法', p: '舞台猜词：一名画家实时作画，其余玩家同时抢答，答对可得分，轮流当画家后累计积分。悄悄话传画：每轮从一人选词画起，画与猜交替传给下一人，最后全体投票判断最终猜词是否仍符合原词。' },
        ...
        { h: '揭示与投票', p: '所有人完成后逐步揭示整条传话链，每人投票给最有趣的一步，得票最多的那步的作者获胜。' },
    ...
    sheeptile: {
      title: '羊了个羊',
      sections: [
        { h: '游戏目标', p: '把堆叠的卡牌全部消除即可通关。共两关：第 1 关轻松热身，第 2 关非常硬核。' },
        { h: '消除规则', p: '点击没有被上层遮挡的卡牌，它会飞入底部的 7 格槽位。槽位中集齐 3 张相同图案自动消除。' },
        { h: '爆槽出局', p: '槽位被 7 张未消除的卡牌占满就爆槽出局。出局后可观战。' },
        { h: '暗牌队列', p: '第 2 关底部有面朝下的暗牌队列（❔），只有露出的一端能点，点开才知道是什么图案——很考验规划。' },
