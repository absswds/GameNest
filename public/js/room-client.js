...
(function() {
  ...
  function updateWaitingRoom() {
    ...
    const maxSlots = players && players.length > 0
      ? Math.max(players.length, game === 'doudizhu' ? 3 : game === 'tictactoe' || game === 'gomoku' || game === 'chinesechess' || game === 'go9' ? 2 : game === 'truthdare' ? 10 : game === 'twentyfour' ? 6 : 4)
      : (game === 'doudizhu' ? 3 : game === 'tictactoe' || game === 'gomoku' || game === 'chinesechess' || game === 'go9' ? 2 : game === 'truthdare' ? 10 : game === 'twentyfour' ? 6 : 4);
